...
namespace gl {
    ...
    struct GABRIEL_API Style final {
        Font* font = null;
    ...
    struct GABRIEL_API TextShader : Shader {
        UniformV4F textColor = { "textColor", { 1, 1, 1, 1 } };

        void update(Style& style);
    };

    struct GABRIEL_API Text2dRenderer final {
    ...
    struct GABRIEL_API Text3dRenderer final {
