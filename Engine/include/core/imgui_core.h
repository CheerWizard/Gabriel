...
namespace gl {
    ...
    struct GABRIEL_API Color final {
    ...
    struct GABRIEL_API ColorF final {
    ...
    struct GABRIEL_API Colors final {
    ...
    struct GABRIEL_API ColorsF final {
    ...
    struct GABRIEL_API ImguiCoreCallback {
        ...
        virtual void resample(int samples);
    };

    struct GABRIEL_API ImguiCore final {
