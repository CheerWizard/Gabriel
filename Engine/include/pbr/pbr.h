...
namespace gl {
    ...
    struct GABRIEL_API PBR_Pixel final {
        EntityID entityId = InvalidEntity;
    };

    struct GABRIEL_API PBR_Entity : Entity {
    ...
    struct GABRIEL_API PBR_ForwardRenderer final {
    ...
    struct GABRIEL_API PBR_GBuffer final {
    ...
    struct GABRIEL_API PBR_DeferredRenderer final {
        DirectShadow* directShadow = null;
        PointShadow* pointShadow = null;
    ...
    struct GABRIEL_API PBR_Skeletal_ForwardRenderer : SkeletalRenderer {
        PBR_Skeletal_ForwardRenderer();
        void update(Environment* env);
    };

    struct GABRIEL_API PBR_Skeletal_DeferredRenderer : SkeletalRenderer {
        PBR_Skeletal_DeferredRenderer();
        void update(Environment* env);
    };

    struct GABRIEL_API PBR_Pipeline final {
        Scene* scene;
